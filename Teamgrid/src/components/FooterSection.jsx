      ...
      >
            ...
            <Grid item xs={12} md={6}>
              <Box sx={{ maxWidth: 488, mx: "auto" }}>
                ...
                <Typography color="#b0bfd0" fontSize="16px" mb={2}>
                  ...
                  guidance or any queries about your project or digital
                  solution.
                </Typography>
        ...
        >
          <Typography fontSize="16px" sx={{ mb: 5, mt: 3 }}>
            <strong>Disclaimer:</strong> Content and services on this site are
            for general information only and may change. Teamgrid is not liable
            for outcomes influenced by third-party tools or evolving
            technologies.
          </Typography>
